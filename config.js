...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/WW3qVz8.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'John Ai Bot' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'johncolins' : process.env.OWNER_NAME,
